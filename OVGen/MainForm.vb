...
Public Class MainForm
    ...
    Public Const DefaultFFmpegCommandLineJoinAudio As String = "-f image2pipe -framerate {framerate} -c:v png -i {img} -i {audio} -c:a aac -b:a 384k -c:v libx264 -crf 0 -bf 2 -flags +cgop -pix_fmt yuv420p -movflags faststart {outfile}"
    Public Const DefaultFFmpegCommandLineSilence As String = "-f image2pipe -framerate {framerate} -c:v png -i {img} -c:v libx264 -crf 0 -bf 2 -flags +cgop -pix_fmt yuv420p -movflags faststart {outfile}"
